...
public class ChangeActiveCreatureView {
    ...
    public ChangeActiveCreatureView() {
        JFrame frame = new JFrame("Change Active Creature");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frame.setSize(500, 500);

        JPanel panel = new JPanel(new GridLayout(0, 5, 5, 5)); // 5 columns, gap of 5 pixels

        JLabel activeCreatureLabel = new JLabel("Current Acitve Creature: Chocowool");
        activeCreatureLabel.setHorizontalAlignment(JLabel.CENTER);
        frame.add(activeCreatureLabel, BorderLayout.NORTH);
